  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Foox again - Your ultimate marketplace for connecting freelancers and companies offering jobs, empowering economic opportunities."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Foox again - Your ultimate marketplace for connecting freelancers and companies offering jobs, empowering economic opportunities.`}
            </Text>
            <Box
